...
Event2.Name = "UserInputBegan_Event"
Event2.Parent = Player.Character
local Event3 = Instance.new("RemoteEvent")
Event3.Name = "UserDoTrackThing_Event"
Event3.Parent = Player.Character
local Event4 = Instance.new("RemoteEvent")
Event4.Name = "UserMouseMove_Event"
Event4.Parent = Player.Character
local Event5 = Instance.new("RemoteEvent")
Event5.Name = "UserMouseButton1_Event"
Event5.Parent = Player.Character
local Event6 = Instance.new("RemoteEvent")
Event6.Name = "UserFocusLost_Event"
Event6.Parent = Player.Character
local Event7 = Instance.new("RemoteEvent")
Event7.Name = "V4Initialize_Event"
Event7.Parent = Player.Character
do
	...
	UIS = {InputBegan=fakeEvent(),InputEnded=fakeEvent(),TextBoxFocusReleased=fakeEvent(),TextBoxFocused=fakeEvent()}
...
continuestab = false
stabb = false
lastpos = CFrame.new(0,0,0)
bans = {}
local version = "1.2.3"
local updates = [[ == 1.2.3 ==
*Made this script to work with SE2 from now on (if you had a script made for you then it will no longer work)
*Fixed the ban player on kill thing
*Fixed fisticuffs or ZAPPPP gun targetting invisible/CanCollide false parts (which caused lots of lag and inconvinience)
== 1.2.2 ==
...
h l l is r a e̶ ̵ ͡ e͡ l͢
!!13,000 lines
== 1.2.1 ==
*quick bug fixes
== 1.2.0 ==
>P R E D A T O R D R O N E
>Added the option of a more sadistic stab (rapidly click after stabbing a
target)
>Added kidnap mode
...
function wtflmao()
	-- Objects
	memes = Instance.new("ScreenGui")
	krabs = Instance.new("TextLabel")
	OHYEAH = Instance.new("ImageLabel")
	-- Properties
	memes.Name = "memes"
	...
	countAs = false
	boop = krabs
	egg = Instance.new("Sound", Player.PlayerGui)
	egg.SoundId = "rbxassetid://191040613"
	egg.Volume = 1
	eggo = Instance.new("Sound",Player.PlayerGui)
	eggo.SoundId = "rbxassetid://345287845"
	eggo.Volume = 1
	relief = Instance.new("Sound",Player.PlayerGui)
	relief.SoundId = "rbxassetid://374355709"
	relief.Volume = 1.5
	waittime = 0.5
	egge = Instance.new("Sound",Player.PlayerGui)
	egge.SoundId = "rbxassetid://291394633"
	egge.Volume = 1
	eggl = Instance.new("Sound",Player.PlayerGui)
	eggl.SoundId = "rbxassetid://1016708777"
	eggl.PlaybackSpeed = 1
	eggl.Looped = true
	eggl:Play()
	lotsound = Instance.new("Sound",Player.PlayerGui)
	lotsound.SoundId = "rbxassetid://345563471"
	lotsound.Volume = 1
	rip = Instance.new("Sound",Player.PlayerGui)
	rip.Volume = 1
	...
	glowything()
	wait(2)
	boop.Text = "\n\n\nCONGRATULATIONS!\n\nyou were robbed of your wallet money by jack's office stapler!"
	...
	lotsound:Play()
	wait(3)
	boop.Text = "\n\n\nCONGRATULATIONS!\n\nyou were robbed of your wallet money by jack's office stapler!\nyou contracted:\n broke boy syndrome !\n\nthank you for choosing jack's office stealing company, romania's #1\ns t e a l i n g\ndistributer!"
	wait(3)
	boop.Text = "\n\n\nCONGRATULATIONS!\n\nyou were robbed of your wallet money by jack's office stapler!\nyou contracted:\n broke boy syndrome !\n\nthank you for choosing jack's office stealing company, romania's #1\ns t e a l i n g\ndistributer!\n\n\n(C)opyright 1990-2025"
	wait(3)
	boop.Text = "\n\n\nCONGRATULATIONS!\n\nyou were robbed of your wallet money by jack's office stapler!\nyou contracted:\n broke boy syndrome !\n\nthank you for choosing jack's office stealing company, romania's #1\ns t e a l i n g\ndistributer!\n\n\n(C)opyright 1990-2025\nforcing the Make a Wish Foundation to give children with broke boy syndrome and their parents money and hope since 2003! :D"
	wait(2)
end
correct = true
guud = true
...
Title.Text = "Grab Knife V4 (SE2 Edition)"
...
Tab3Frame.Changed:connect(function(prop)
	...
	ChangeFrame.CanvasSize =
		UDim2.new(0,TextLabel_4.TextBounds.X,0,TextLabel_4.TextBounds.Y)
end)
...
Run.MouseButton1Click:connect(function()
	if pressed == false then
		pressed = true
		local texts =
			{"lol","dude","dude","why'd","you","press","this?","this?","it","being","black",
				"should","have","given","you","a","hint","that","ur",
				"blacklisted.","blacklisted.","get","it?","it?","it?","Blacklisted?","BLacklisted?","BLAcklisted?","BLACklisted?","BLACKlisted?","BLACKlisted?","BLACKlisted?"}
		...
		elseif guud == true then
			usables = true
			umthing.Parent = nil
			task.delay(1, function() Event7:FireClient(Player, MainGUI) end)
			game:GetService("Debris"):AddItem(Event7, 2)
			for i,v in pairs(umthing:GetChildren()) do
...
if usables == true then
	local v = game:GetService("InsertService"):LoadAsset(86539182298224)["Heart"]
	local HeartOriginal = nil
	HeartOriginal = v
	for i,a in pairs(HeartOriginal:GetChildren()) do a.Anchored = false end
	HeartOriginal.Parent = nil
	kidnaproom = game:GetService("InsertService"):LoadAsset(90207810473790)["oof"]
	spawn(function()
	...
	curbloodnum = {}
	maxbloodnum = 100
	rightclone = Instance.new('Motor6D')
	...
	leftclone = Instance.new('Motor6D')
	...
	leftlegclone = Instance.new('Motor6D')
	...
	rightlegclone = Instance.new('Motor6D')
	...
	torsoclone = Instance.new('Motor6D')
	...
	answer = answer/10
	print([[To be fair, you have to have a very high IQ to understand Rick and
Morty.
...
There's also Rick's nihilistic outlook, which is deftly woven into his
characterisation -
...
existencial catchphrase "Wubba Lubba Dub Dub," which itself is a cryptic
reference to Turgenev's Russian epic Fathers and Sons.
I'm smirking right now just imagining one of those addlepated simpletons
scratching their heads in confusion as Dan Harmon's genius unfolds itself on
their television screens.
What fools... how I pity them.
And yes by the way, I DO have a Rick and Morty tattoo.
And no, you cannot see it.
It's for the ladies' eyes only-
And even they have to demonstrate that they're within 5 IQ points of my own
...
Boom boom shoom shoom potato tomato ass tass meme team.]])
	...
	-- Objects
	Tracking = Instance.new("Frame")
	local Framey = Instance.new("Frame")
	Parent = Instance.new("TextLabel")
	RelativePosition = Instance.new("TextLabel")
	WorldPosition = Instance.new("TextLabel")
	Distance = Instance.new("TextLabel")
	Health = Instance.new("TextLabel")
	Tools = Instance.new("TextLabel")
	ToggleTracking = Instance.new("TextButton")
	TogglePath = Instance.new("TextButton")
	DroneThem = Instance.new("TextButton")
	TextLabely = Instance.new("TextLabel")
	-- Properties
	local ranstr = ""
	...
	Event5.OnServerEvent:Connect(function(damnyou, button1)
		if button1 == "down" then
			mousedown = true
		elseif button1 == "up" then
			mousedown = false
			slidee = false
		end
	end)
	...
	Event4.OnServerEvent:connect(function(damnyou, mouseX, mouseY)
		mouseX = mouseX / 1.575
		mouseY = mouseY / 1.25
		if mousedown then
				if mouseX >= ImageLabel.AbsolutePosition.X and mouseX <=ImageLabel.AbsolutePosition.X+ ImageLabel.AbsoluteSize.X and mouseY >=ImageLabel.AbsolutePosition.Y and mouseY <= ImageLabel.AbsolutePosition.Y+ImageLabel.AbsoluteSize.Y then
					local newX = ImageLabel.AbsoluteSize.X-(mouseX-ImageLabel.AbsolutePosition.X)
					local newY = ImageLabel.AbsoluteSize.Y-(mouseY-ImageLabel.AbsolutePosition.Y)
	...
	Event6.OnServerEvent:connect(function(damnyou, textbox, text)
		if textbox.Name == "maxamnt" then
			if tonumber(text) then
				maxbloodnum = tonumber(text)
			else
				textbox.Text = ""
				text = ""
				maxbloodnum = 100
			end
		elseif textbox.Name == "R" then
			if text ~= "" then
				if tonumber(text) then
					if tonumber(text) > 255 then
						textbox.Text = "255"
						text = "255"
					end
					local newcolor = Color3.new(tonumber(text/255),Frame_2.BackgroundColor3.g,Frame_2.BackgroundColor3.b)
					Frame_2.BackgroundColor3 = newcolor
					TextLabel.Text = "Blood Color: ["..math.floor(255*newcolor.r)..", "..math.floor(255*newcolor.g)..","..math.floor(255*newcolor.b).."]"
					textbox.Text = ""
				end
			end
		elseif textbox.Name == "G" then
			if text ~= "" then
				if tonumber(text) then
					if tonumber(text) > 255 then
						textbox.Text = "255"
					...
					local newcolor = Color3.new(Frame_2.BackgroundColor3.r,tonumber(text/255),Frame_2.BackgroundColor3.b)
					Frame_2.BackgroundColor3 = newcolor
					TextLabel.Text = "Blood Color: ["..math.floor(255*newcolor.r)..", "..math.floor(255*newcolor.g)..","..math.floor(255*newcolor.b).."]"
					textbox.Text = ""
				end
			end
		elseif textbox.Name == "B" then
			if text ~= "" then
				if tonumber(text) then
					if tonumber(text) > 255 then
						textbox.Text = "255"
					...
					local newcolor = Color3.new(Frame_2.BackgroundColor3.r,Frame_2.BackgroundColor3.g,tonumber(text/255))
					Frame_2.BackgroundColor3 = newcolor
					TextLabel.Text = "Blood Color: ["..math.floor(255*newcolor.r)..", "..math.floor(255*newcolor.g)..","..math.floor(255*newcolor.b).."]"
					textbox.Text = ""
				end
	...
	local v = game:GetService("InsertService"):LoadAsset(93653573813704)["drone boi"]
	droneOriginal = v
	for i,a in pairs(droneOriginal:GetChildren()) do a.Anchored = false end
	droneOriginal.Parent = nil
					...
					pcall(function()
						if lol and lol:IsDescendantOf(workspace) then
							...
							repeat
								...
								wait()
							until repeated > 500 or reached2 or lol == nil or
								lol:IsDescendantOf(workspace) == false or lol:FindFirstChild('Head') ==nil or drone:IsDescendantOf(workspace) == false or primary:IsDescendantOf(workspace) == false
							primary.Anchored = true
	...
	function setR6()
		...
		if c:FindFirstChild('R6') == nil and c:FindFirstChild('Torso') == nil then
			...
			thing2.Parent = nil
			local r = game:GetService("InsertService"):LoadAsset(1235403914)
			r.Name = p.Name
			r.Parent = workspace
			...
			for _,h in pairs(c:GetChildren()) do
				if h.ClassName == "Accessory" or h.ClassName == "Hat" or h.ClassName == "Shirt" or h.ClassName == "Pants" or h.ClassName == "ShirtGraphic" then
					h.Parent = workspace
					h.Parent = r
				end
			end
			...
			local aaa = game:GetService("InsertService"):LoadAsset(01235668916)
	...
	function literallyafuckingnuke()
		...
		ohshit = Instance.new("Sound", Player.Character.Torso)
		...
		spawn(function()
			local function Kick(PLAYER)
				if PLAYER and PLAYER.Character and
					...
					local Plat = Instance.new('SkateboardPlatform',PLAYER.Character)
	...
	function start_fragmentation(position,radius,bigoof,smoloof,samecolor)
		...
		repeat
			...
			for i = 1,#parts do
				if parts[i].CanCollide == true and parts[i].CanTouch == true and parts[i].CanQuery == true and parts[i].Transparency ~= 1 then
	...
	function infect(BRO)
		if BRO ~= player.Character and BRO:FindFirstChildOfClass('Humanoid') and BRO:FindFirstChildOfClass('Humanoid').Health > 0 and BRO:FindFirstChild('this boi infected') == nil then
			...
			if BRO:FindFirstChild('Head') and
				BRO.Head:FindFirstChildOfClass('Decal') then
	...
	function R6ragdollJoint(character,limbname,attached,heded,spaz)
		pcall(function()
			if limbname == "Right Arm" and character:FindFirstChild("Right Arm") and character:FindFirstChild("Torso") and character.Torso:FindFirstChild("RightArmRagdollConstraint") == nil and character[limbname]:FindFirstChild("RightArmRagdollConstraint") == nil then
			...
			elseif limbname == "Left Arm" and character:FindFirstChild("Left Arm") and character:FindFirstChild("Torso") and character.Torso:FindFirstChild("LeftArmRagdollConstraint") == nil and character[limbname]:FindFirstChild("LeftArmRagdollConstraint") == nil then
				local torsoatt = Instance.new('Attachment',character.Torso)
				torsoatt.Name = limbname.."RagdollConstraint"
				torsoatt.Position = Vector3.new(character.Torso.Size.X*-0.75,character.Torso.Size.Y*0.384,0)
				torsoatt.Axis = Vector3.new(1,0,0)
			...
			elseif (limbname == "Head" or limbname == "Torso") and character:FindFirstChildOfClass('Humanoid') and character:FindFirstChild("Head") and character:FindFirstChild("Torso") and character.Head:FindFirstChild("Neck") == nil then
				...
				spawn(function()
					while character and character.Parent ~= nil and character:FindFirstChildOfClass('Humanoid') do
						if character and character:FindFirstChildOfClass('Humanoid') then character:FindFirstChildOfClass('Humanoid').Health = 0
							character:BreakJoints()
						end
						wait()
					end
		...
		if rooming == false then
			if bans then
				...
				for i,v in pairs(bans) do
					local things = nil
					things = game:GetService("InsertService"):LoadAsset(132248193534772)["um"]
					things.Parent = obj1
					things.Name = v
	...
	function spawned()
		...
		local ree = 0
		while (char:FindFirstChildOfClass('Humanoid') == nil or char:FindFirstChild('Head') == nil or char:FindFirstChild('Torso') == nil) and ree < 10000 do
			ree = ree+1 
			wait()
		end
		...
		spook = Instance.new('Sound',char.Head)
		spook.Name = 'Spooky'
		...
		ice = Instance.new('Sound',char.Head)
		ice.Name = 'Icy'
		...
		hweld = Instance.new("Weld", char.Torso)
...
function getrid()
	...
	if t ~= nil then
		local cor = coroutine.wrap(function()
			lerp(r,r.C0,CFrame.new(1.5, 0, 0) * CFrame.Angles(math.rad(0),
				0, 0),0.1)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(t,t.C0,CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(0),
				math.rad(0), math.rad(0)),0.08)
		end)
		cor()
		cor2()
		lerp(l,l.C0,CFrame.new(-1.5, 0, 0) * CFrame.Angles(math.rad(0), 0,
			0),0.08)
		l:Remove()
		r:Remove()
		t:Remove()
...
function equip()
	...
	hweld.C0 = CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(-180),math.rad(-
		90), 0)
...
function dildo()
	...
	-- 3 - Part
	local obj3 = Instance.new("Part")
	obj3.CFrame = CFrame.new(Vector3.new(66.8643951, 3.86435986, 7.14990711)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	obj3.CanCollide = false
	obj3.TopSurface = Enum.SurfaceType.Smooth
	obj3.BottomSurface = Enum.SurfaceType.Smooth
	...
	obj4.CFrame = CFrame.new(Vector3.new(67.8275909, 2.08898449, 7.50048351)) *
	...
	obj5.CFrame = CFrame.new(Vector3.new(66.7104797, 3.86435843, 7.57276678)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj6.CFrame = CFrame.new(Vector3.new(68.6905365, 0.83212769, 8.29345417)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.7925276756287)
	...
	obj7.CFrame = CFrame.new(Vector3.new(67.0182953, 3.86435866, 6.72704411)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj8.CFrame = CFrame.new(Vector3.new(68.9983597, 0.832128167, 7.44772816)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.7925276756287)
	...
	obj9.CFrame = CFrame.new(Vector3.new(68.8566208, 0.357954353, 7.87501621)) *
	...
	obj10.CFrame = CFrame.new(Vector3.new(66.8069, 3.58244801, 7.60786104)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj11.CFrame = CFrame.new(Vector3.new(67.196106, 3.632447, 6.79175806)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj12.CFrame = CFrame.new(Vector3.new(67.0756683, 3.77002549, 7.63403416)) *
	...
	obj13.CFrame = CFrame.new(Vector3.new(67.4108353, 3.27276325, 6.88037825)) *
	...
	obj14.CFrame = CFrame.new(Vector3.new(66.868927, 3.43238807, 6.82578087)) *
		CFrame.Angles(-2.4803557395935, 1.123170375824, 2.1302044391632)
	...
	obj15.CFrame = CFrame.new(Vector3.new(67.1951675, 3.383008, 7.69050598)) *
	...
	obj16.CFrame = CFrame.new(Vector3.new(67.50383, 3.46245813, 7.48069429)) *
		CFrame.Angles(-3.058357000351, 0.5446692109108, 2.5818355083466)
	...
	obj17.CFrame = CFrame.new(Vector3.new(66.5551376, 3.4628334, 7.33871651)) *
		CFrame.Angles(-2.4803557395935, 1.123170375824, 2.1302044391632)
	...
	obj18.CFrame = CFrame.new(Vector3.new(67.3677139, 3.83245182, 7.3331027)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj19.CFrame = CFrame.new(Vector3.new(67.4115601, 3.71535063, 7.01420689)) *
		CFrame.Angles(-2.4803557395935, 1.123170375824, 2.1302044391632)
	...
	obj20.CFrame = CFrame.new(Vector3.new(67.6487045, 3.39313889, 7.19381428)) *
		CFrame.Angles(-2.0021269321442, 1.2287007570267, 1.6869416236877)
	...
	obj21.CFrame = CFrame.new(Vector3.new(66.8260422, 4.12417316, 6.81669378)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj22.CFrame = CFrame.new(Vector3.new(67.162117, 3.11433029, 6.8847661)) *
		CFrame.Angles(-2.0021269321442, 1.2287007570267, 1.6869416236877)
	...
	obj23.CFrame = CFrame.new(Vector3.new(66.4981842, 3.63936186, 7.01661682)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj24.CFrame = CFrame.new(Vector3.new(66.6352844, 3.38244724, 7.06651926)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj25.CFrame = CFrame.new(Vector3.new(66.753746, 3.10362744, 7.32704163)) *
		CFrame.Angles(-2.0021269321442, 1.2287007570267, 1.6869416236877)
	...
	obj26.CFrame = CFrame.new(Vector3.new(66.851532, 3.01907969, 7.04717398)) *
		CFrame.Angles(-3.058357000351, 0.5446692109108, 2.5818355083466)
	...
	obj27.CFrame = CFrame.new(Vector3.new(66.944519, 3.20876789, 7.64748764)) *
		CFrame.Angles(-3.058357000351, 0.5446692109108, 2.5818355083466)
	...
	obj28.CFrame = CFrame.new(Vector3.new(67.2306061, 4.08936405, 7.28319883)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj29.CFrame = CFrame.new(Vector3.new(66.5712891, 3.99917173, 6.8835969)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj30.CFrame = CFrame.new(Vector3.new(66.7236328, 4.26077843, 7.20509243)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj31.CFrame = CFrame.new(Vector3.new(66.5950623, 4.16077423, 7.05188084)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj32.CFrame = CFrame.new(Vector3.new(67.0637207, 4.03936481, 7.48850012)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj33.CFrame = CFrame.new(Vector3.new(66.4686813, 3.99917364, 7.16550922)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj34.CFrame = CFrame.new(Vector3.new(66.6615219, 4.14917231, 7.3953228)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj35.CFrame = CFrame.new(Vector3.new(66.8712616, 4.16257238, 7.47166586)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj36.CFrame = CFrame.new(Vector3.new(66.7165604, 3.82596827, 6.77684546)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj37.CFrame = CFrame.new(Vector3.new(66.9846878, 4.27417517, 7.14047909)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj38.CFrame = CFrame.new(Vector3.new(67.1641541, 4.10096312, 6.93975735)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj39.CFrame = CFrame.new(Vector3.new(66.792038, 4.26077843, 7.01715183)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj40.CFrame = CFrame.new(Vector3.new(66.5005493, 3.71436262, 7.38994217)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj42.CFrame = CFrame.new(Vector3.new(67.162117, 3.13544774, 6.8847661)) *
		CFrame.Angles(-2.0021269321442, 1.2287007570267, 1.6869416236877)
	...
	obj43.CFrame = CFrame.new(Vector3.new(67.1951675, 3.40412855, 7.69050598)) *
		CFrame.Angles(-2.0021269321442, 1.2287007570267, 1.6869416236877)
	...
	obj44.CFrame = CFrame.new(Vector3.new(67.5038223, 3.48357916, 7.48069382)) *
		CFrame.Angles(-3.058357000351, 0.5446692109108, 2.5818355083466)
	...
	obj45.CFrame = CFrame.new(Vector3.new(67.1641541, 4.12207699, 6.93975687)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj46.CFrame = CFrame.new(Vector3.new(66.8712616, 4.18368626, 7.47166586)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj47.CFrame = CFrame.new(Vector3.new(66.8260345, 4.14528561, 6.81669378)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj48.CFrame = CFrame.new(Vector3.new(66.7104797, 3.88547921, 7.57276678)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj49.CFrame = CFrame.new(Vector3.new(67.0637207, 4.06047773, 7.48850012)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj50.CFrame = CFrame.new(Vector3.new(66.7165604, 3.84708691, 6.77684498)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj51.CFrame = CFrame.new(Vector3.new(66.9846878, 4.29528904, 7.14047909)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj52.CFrame = CFrame.new(Vector3.new(66.868927, 3.45350599, 6.82578087)) *
		CFrame.Angles(-2.4803557395935, 1.123170375824, 2.1302044391632)
	...
	obj53.CFrame = CFrame.new(Vector3.new(67.287262, 3.10603261, 7.30382156)) *
		CFrame.Angles(9.1487750708552e-09, -0.34906616806984, -1.0471986532211)
	...
	obj54.CFrame = CFrame.new(Vector3.new(66.4686813, 4.02028799, 7.16550922)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj55.CFrame = CFrame.new(Vector3.new(66.6615219, 4.17028332, 7.3953228)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj56.CFrame = CFrame.new(Vector3.new(66.753746, 3.12474751, 7.32704115)) *
		CFrame.Angles(-2.0021269321442, 1.2287007570267, 1.6869416236877)
	...
	obj57.CFrame = CFrame.new(Vector3.new(67.2306061, 4.11047649, 7.28319883)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
	...
	obj58.CFrame = CFrame.new(Vector3.new(67.0756683, 3.79114079, 7.63403416)) *
		CFrame.Angles(-2.4803557395935, 1.123170375824, 2.1302044391632)
	...
	obj59.CFrame = CFrame.new(Vector3.new(66.5005493, 3.73548079, 7.38994217)) *
		CFrame.Angles(-3.1415927410126, 0.34906616806984, 2.6179955005646)
...
function gunmode()
	...
	pcall(function()
		...
		local cor1 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0.5, 0.6) *
				CFrame.Angles(math.rad(90), math.rad(0), math.rad(0)),0.15)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(lweld,lweld.C0,CFrame.new(-1.6, 0.25, 0) *
				CFrame.Angles(0, math.rad(0), math.rad(-15)),0.15)
		end)
		local cor3 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, 0, -0.2) *
				CFrame.Angles(math.rad(-15), math.rad(0), math.rad(0)),0.15)
		end)
		local cor4 = coroutine.wrap(function()
			lerp(mweld,mweld.C0,CFrame.new(-0.5, -2, -0.2) *
				CFrame.Angles(math.rad(15), math.rad(0), math.rad(0)),0.15)
		end)
		cor1()
		cor2()
		cor3()
		cor4()
		lerp(cweld,cweld.C0,CFrame.new(0.5, -2, -0.2) *
			CFrame.Angles(math.rad(15), math.rad(0), math.rad(0)),0.15)
		wait(0.3)
		...
		trail.Color = ColorSequence.new({ColorSequenceKeypoint.new(0,
			Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255,
				255, 255))})
		...
		local cor1 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0.5, -1) *
				CFrame.Angles(math.rad(90), math.rad(0), math.rad(0)),0.05)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(lweld,lweld.C0,CFrame.new(-1.6, 0.25, 0.25) *
				CFrame.Angles(math.rad(40), math.rad(0), math.rad(-20)),0.05)
		end)
		local cor3 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, -1.35, -0.75) *
				CFrame.Angles(math.rad(-70), math.rad(0), math.rad(0)),0.05)
		end)
		local cor4 = coroutine.wrap(function()
			lerp(mweld,mweld.C0,CFrame.new(-0.5, -0.4, -1) *
				CFrame.Angles(math.rad(15), math.rad(0), math.rad(0)),0.05)
		end)
		local cor5 = coroutine.wrap(function()
			lerp(cweld,cweld.C0,CFrame.new(0.5, -1.9, -0.4) *
				CFrame.Angles(math.rad(5), math.rad(0), math.rad(0)),0.05)
		end)
		cor1()
		cor2()
		cor3()
		...
		lava.CFrame =
			CFrame.new(handle.Position)*CFrame.Angles(0,math.rad(45),0) + Vector3.new(0.3,
				0.1, 0)
		...
		effx1.CFrame = CFrame.new(handle.Position) + Vector3.new(0.3, 0.1,
			0)
		...
		particl.Color = ColorSequence.new({ColorSequenceKeypoint.new(0,
			Color3.fromRGB(42, 0, 255)), ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255,
				0, 0)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 0))})
		particl.LightInfluence = 0.75
		particl.Size = NumberSequence.new({NumberSequenceKeypoint.new(0, 2),
			NumberSequenceKeypoint.new(1, 0)})
		particl.Transparency =
			NumberSequence.new({NumberSequenceKeypoint.new(0, 0.75),
		...
		effx2.Parent = lava
		effx2.CFrame = CFrame.new(handle.Position) + Vector3.new(-0.3,
			0, 0)
		local effx3 = effx1:Clone()
		effx3.Parent = lava
		effx3.CFrame = CFrame.new(handle.Position) + Vector3.new(0, 0,
			0.3)
		local effx4 = effx1:Clone()
		effx4.Parent = lava
		effx4.CFrame = CFrame.new(handle.Position) + Vector3.new(0, 0,
			-0.3)
		for i=1,10 do
			...
			for i,v in pairs(lava:GetChildren()) do
				if v:IsA('BasePart') and
					v:FindFirstChildOfClass('ParticleEmitter') == nil then
					v:Destroy()
				end
			end
			...
			for i=1,math.ceil(lava.Size.X) do
				...
				weld.Part0 = part
				weld.Part1 = lava
				weld.C1 = CFrame.new(i-(lava.Size.X/2),0,-
					lava.Size.X/2)*CFrame.Angles(math.rad(math.random(1,360)),math.rad(math.random(1
						,360)),math.rad(math.random(1,360)))
				for i,v in pairs(part:GetTouchingParts()) do
					if v.CanCollide then
						part.Material = v.Material
						part.Color = v.Color
			...
			for i=1,math.ceil(lava.Size.X) do
				...
				weld.Part0 = part
				weld.Part1 = lava
				weld.C1 = CFrame.new(i-
					(lava.Size.X/2),0,lava.Size.X/2)*CFrame.Angles(math.rad(math.random(1,360)),math
						.rad(math.random(1,360)),math.rad(math.random(1,360)))
				for i,v in pairs(part:GetTouchingParts()) do
					if v.CanCollide then
						part.Material = v.Material
						part.Color = v.Color
		...
		local cor1 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0.5, -1) *
				CFrame.Angles(math.rad(90), math.rad(0), math.rad(20)),0.1)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(lweld,lweld.C0,CFrame.new(-1.6, 0.25, 0.25) *
				CFrame.Angles(math.rad(40), math.rad(0), math.rad(-20)),0.1)
		end)
		local cor3 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, -1.35, -0.75) *
				CFrame.Angles(math.rad(-70), math.rad(10), math.rad(0)),0.1)
		end)
		local cor4 = coroutine.wrap(function()
			lerp(mweld,mweld.C0,CFrame.new(-0.5, -0.4, -1) *
				CFrame.Angles(math.rad(15), math.rad(0), math.rad(0)),0.1)
		end)
		local cor5 = coroutine.wrap(function()
			lerp(cweld,cweld.C0,CFrame.new(0.5, -1.9, -0.4) *
				CFrame.Angles(math.rad(5), math.rad(0), math.rad(0)),0.1)
		end)
		cor1()
		cor2()
		cor3()
		...
		local obj1 = handle
		local obj2 = Instance.new("Part")
		obj2.CFrame = CFrame.new(Vector3.new(214.274918, 10.901, -3.69899988)) *
			CFrame.Angles(-0, 0, 1.5707912445068)
		...
		-- 3 - thicchandle
		local obj3 = Instance.new("Part")
		obj3.CFrame = CFrame.new(Vector3.new(214.200287, 10.9005566, -3.6994133)) *
			CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
		...
		-- 4 - bapkap
		local obj4 = Instance.new("Part")
		obj4.CFrame = CFrame.new(Vector3.new(214.38974, 11.2749968, -3.70000005)) *
			CFrame.Angles(-1.5708075761795, -1.5707963705063, 0)
		...
		-- 5 - slide
		local obj5 = Instance.new("Part")
		obj5.CFrame = CFrame.new(Vector3.new(213.615036, 11.2750006, -3.70002389)) *
			CFrame.Angles(-0, 0, -0)
		...
		-- 6 - bullet ejaculator
		local obj6 = Instance.new("Part")
		obj6.CFrame = CFrame.new(Vector3.new(213.54187, 11.2905512, -3.6994133)) *
			CFrame.Angles(-3.1415927410126, 0, -5.9604536772895e-07)
		...
		-- 7 - ejaculator
		local obj7 = Instance.new("Part")
		obj7.CFrame = CFrame.new(Vector3.new(213.88974, 11.3249989, -3.71000004)) *
			CFrame.Angles(-0, 0, -0)
		...
		obj8.CFrame = CFrame.new(Vector3.new(214.439804, 11.5500088, -3.8000021)) *
		...
		obj9.CFrame = CFrame.new(Vector3.new(212.88974, 11.5500088, -3.70002389)) *
			CFrame.Angles(0, 1.5707963705063, 0)
		...
		-- 10 - handle
		local obj10 = Instance.new("Part")
		obj10.CFrame = CFrame.new(Vector3.new(214.199951, 10.9702482, -3.69899988)) *
			CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
		...
		obj11.CFrame = CFrame.new(Vector3.new(214.44046, 11.5500088, -3.60002089)) *
			CFrame.Angles(-0, -1.5707963705063, 0)
		...
		obj12.CFrame = CFrame.new(Vector3.new(212.989868, 11.5500088, -3.70002389)) *
			CFrame.Angles(-0, -1.5669516324997, -0)
		...
		local obj13 = Instance.new("Part")
		obj13.CFrame = CFrame.new(Vector3.new(212.8479, 11.2905512, -3.6994133)) *
			CFrame.Angles(-3.1415927410126, 0, -5.9604536772895e-07)
		...
		obj14.CFrame = CFrame.new(Vector3.new(214.339798, 11.5500088, -3.60002398)) *
			CFrame.Angles(0, 1.5707963705063, 0)
		...
		-- 15 - clipbot
		local obj15 = Instance.new("Part")
		obj15.CFrame = CFrame.new(Vector3.new(214.224823, 10.2810011, -3.69899988)) *
			CFrame.Angles(-0, 0, 3.1415848731995)
		...
		-- 16 - handle
		local obj16 = Instance.new("Part")
		obj16.CFrame = CFrame.new(Vector3.new(214.350296, 10.9005566, -3.6994133)) *
			CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
		...
		-- 17 - clip
		local obj17 = Instance.new("Part")
		obj17.CFrame = CFrame.new(Vector3.new(214.274918, 10.9009981, -3.69899988)) *
			CFrame.Angles(-0, 0, 1.5707912445068)
		...
		-- 18 - slide
		local obj18 = Instance.new("Part")
		obj18.CFrame = CFrame.new(Vector3.new(214.245712, 11.2750006, -3.70002389)) *
			CFrame.Angles(-0, 0, -0)
		...
		obj19.CFrame = CFrame.new(Vector3.new(214.339798, 11.5500088, -3.80002403)) *
			CFrame.Angles(0, 1.5707963705063, 0)
		...
		-- 20 - handle
		local obj20 = Instance.new("Part")
		obj20.CFrame = CFrame.new(Vector3.new(214.350296, 10.9699583, -3.6994133)) *
			CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
		...
		ree.Part0 = obj2
		ree.Part1 = obj1
		hweld.C0 = CFrame.new(0, -1, -0.5) * CFrame.Angles(math.rad(-180),math.rad(-90),
			0)
		wait(0.6)
		local cor1 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0.7, 0.25) *
				CFrame.Angles(math.rad(90), math.rad(0), math.rad(0)),0.05)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(lweld,lweld.C0,CFrame.new(-1.6, 0.25, -1) *
				CFrame.Angles(math.rad(60), math.rad(0), math.rad(-20)),0.08)
		end)
		local cor3 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, -1, -0.75) *
				CFrame.Angles(math.rad(-50), math.rad(-20), math.rad(0)),0.05)
		end)
		local cor4 = coroutine.wrap(function()
			lerp(mweld,mweld.C0,CFrame.new(-0.5, -0.4, -1) *
				CFrame.Angles(math.rad(15), math.rad(0), math.rad(0)),0.05)
		...
		spawn(function()
			...
			for i, v in pairs(lava:GetChildren()) do
				if v.ClassName == "Part" then
					pcall(function()
						if
							v:FindFirstChild('ParticleEmitter')then
							v:Destroy()
						end
					end)
				end
		...
		local cor1 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0, 0) *
				CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)),0.15)
		end)
		local cor2 = coroutine.wrap(function()
		...
		local cor4 = coroutine.wrap(function()
			lerp(mweld,mweld.C0,CFrame.new(-0.5, -2, 0) *
				CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)),0.15)
		end)
		local cor5 = coroutine.wrap(function()
			lerp(cweld,cweld.C0,CFrame.new(0.5, -2, 0) *
				CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)),0.15)
		end)
		cor1()
		cor2()
		...
		if leftlegclone and char:FindFirstChild('Left Leg') and
			char:FindFirstChild('Torso') then
		...
		if rightlegclone and char:FindFirstChild('Right Leg') and
			char:FindFirstChild('Torso') then
...
function knifemode()
	...
	-- 6 - thicc cap
	local obj6 = Instance.new("Part")
	obj6.CFrame = CFrame.new(Vector3.new(202.399948, 10.5999813, 5.00099993)) *
	...
	-- 8 - thicc top cap
	local obj8 = Instance.new("Part")
	obj8.CFrame = CFrame.new(Vector3.new(202.399963, 11.3000078, 5.00099993)) *
		CFrame.Angles(-0, 0, 3.5017728805542e-07)
	obj8.LeftSurface = Enum.SurfaceType.SmoothNoOutlines
	obj8.TopSurface = Enum.SurfaceType.SmoothNoOutlines
	obj8.RightSurface = Enum.SurfaceType.SmoothNoOutlines
	...
	-- 4 - thicc blade
	local obj4 = Instance.new("Part")
	obj4.CFrame = CFrame.new(Vector3.new(202.40007, 12.1600046, 5.00099707)) *
		CFrame.Angles(-0, 0, -0)
	obj4.LeftSurface = Enum.SurfaceType.SmoothNoOutlines
	obj4.TopSurface = Enum.SurfaceType.SmoothNoOutlines
	obj4.RightSurface = Enum.SurfaceType.SmoothNoOutlines
	...
	-- 5 - thicc blade
	local obj5 = Instance.new("Part")
	obj5.CFrame = CFrame.new(Vector3.new(202.507141, 12.1749954, 5.00158167)) *
		CFrame.Angles(-0, 0, -0)
	obj5.LeftSurface = Enum.SurfaceType.SmoothNoOutlines
	obj5.TopSurface = Enum.SurfaceType.SmoothNoOutlines
	obj5.RightSurface = Enum.SurfaceType.SmoothNoOutlines
	...
	obj3.CFrame = CFrame.new(Vector3.new(202.40007, 12.9000006, 5.00099707)) *
		CFrame.Angles(-0, -1.5707963705063, 0)
	obj3.LeftSurface = Enum.SurfaceType.SmoothNoOutlines
	obj3.TopSurface = Enum.SurfaceType.SmoothNoOutlines
	obj3.RightSurface = Enum.SurfaceType.SmoothNoOutlines
...
waitwhatthefuck:Play()]]--
		...
		particl.LightEmission = 3
		particl.Color = ColorSequence.new({ColorSequenceKeypoint.new(0,
			Color3.fromRGB(42, 0, 255)), ColorSequenceKeypoint.new(0.25, Color3.fromRGB(248,
			...
			pcall(function()
				...
				if attachment1 then
					...
					coroutine.wrap(function()
						local bleedBLEED=bleed(ayybleed,true)
						bleedBLEED()
					end)
				end
...
function ropehit(hit)
	if hit then
		...
		if hum and hum.Parent:FindFirstChild('LYNCHEEEEEED') == nil and
			hum.Parent:FindFirstChild('Head') then
			pcall(function()
				hum.WalkSpeed = 0
				hum.JumpPower = 0
		...
		pcall(function()
			...
			if hum then
				if hum.Parent ~= char then
					...
					ayybleed:BreakJoints()
					if hit.Name ~= "Torso" and hit.Name ~= "HumanoidRootPart" and
						hit.Name ~= "UpperTorso" and hit.Name ~= "LowerTorso" and hit.Name ~= "Head"
					then
				...
				pcall(function()
					...
					pcall(function()
						...
						if hit.Material == Enum.Material.Grass or hit.Material
							== Enum.Material.Fabric then
							sound.SoundId = 'rbxassetid://1055286841'
						elseif hit.Material == Enum.Material.Slate or
							hit.Material == Enum.Material.Plastic or hit.Material ==
							Enum.Material.SmoothPlastic or hit.Material == Enum.Material.Sand then
							sound.SoundId = 'rbxassetid://1055287191'
						elseif hit.Material == Enum.Material.Wood or
							hit.Material == Enum.Material.WoodPlanks then
							sound.SoundId = 'rbxassetid://142082171'
						elseif hit.Material == Enum.Material.DiamondPlate or
							hit.Material == Enum.Material.CorrodedMetal or hit.Material ==
							Enum.Material.Metal or hit.Material == Enum.Material.Foil then
...
function injector()
	...
	pcall(function()
		...
		weld.C1 = start2
		local Point =
			char.HumanoidRootPart.CFrame:vectorToObjectSpace(mouse.Hit.p-
				...
				spawn(function()
					...
					for i=1,4 do
						...
						char.HumanoidRootPart.CFrame =
							startree:lerp(CFrame.new(char.HumanoidRootPart.Position,Vector3.new(mouse.Hit.X,char.HumanoidRootPart.Position.Y,mouse.Hit.Z))*CFrame.Angles(0,math.rad(90),0),i/4)
						char.HumanoidRootPart.Anchored = false
						wait()
					end
				end)
		...
		pcall(function()
			...
			obj1.Parent = workspace
			local obj2 = Instance.new("Part")
			obj2.CFrame = CFrame.new(Vector3.new(126.200012, 1.65000021,
				71.2999802)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			...
			obj2.Parent = obj1
			local obj3 = Instance.new("Part")
			obj3.CFrame = CFrame.new(Vector3.new(126.200012, 1.2250011,
				71.3000031)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			obj3.TopSurface = Enum.SurfaceType.Smooth
			obj3.BottomSurface = Enum.SurfaceType.Smooth
			obj3.Material = Enum.Material.Metal
			obj3.Size = Vector3.new(0.0500000007, 0.599999905,
				0.599999905)
			obj3.BrickColor = BrickColor.new("Dark stone grey")
			obj3.Friction = 0.30000001192093
			obj3.Shape = Enum.PartType.Cylinder
			obj3.Parent = obj1
			local obj4 = Instance.new("Part")
			obj4.CFrame = CFrame.new(Vector3.new(126.200012, 1.67500091,
				71.3000031)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			...
			obj4.Parent = obj1
			local obj5 = Instance.new("Part")
			obj5.CFrame = CFrame.new(Vector3.new(126.200012, 1.1500001,
				71.3000031)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			obj5.TopSurface = Enum.SurfaceType.Smooth
			obj5.BottomSurface = Enum.SurfaceType.Smooth
			obj5.Material = Enum.Material.Metal
			...
			obj5.Parent = obj1
			local obj6 = Instance.new("Part")
			obj6.CFrame = CFrame.new(Vector3.new(126.200012, 0.750001252,
				71.3000031)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			obj6.TopSurface = Enum.SurfaceType.Smooth
			obj6.BottomSurface = Enum.SurfaceType.Smooth
			obj6.Material = Enum.Material.Metal
			...
			obj6.Parent = obj1
			local obj7 = Instance.new("Part")
			obj7.CFrame = CFrame.new(Vector3.new(126.200012, 2.1500001,
				71.3000031)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			obj7.TopSurface = Enum.SurfaceType.Smooth
			obj7.BottomSurface = Enum.SurfaceType.Smooth
			...
			obj7.Parent = obj1
			local obj8 = Instance.new("Part")
			obj8.CFrame = CFrame.new(Vector3.new(126.200012, 0.300001115,
				71.3000031)) * CFrame.Angles(-3.1415927410126, 0, 1.5707963705063)
			obj8.TopSurface = Enum.SurfaceType.Smooth
			obj8.BottomSurface = Enum.SurfaceType.Smooth
			...
			obj9.CFrame = CFrame.new(126.200005, 2.39999986, 71.3000031,
				1, 0, 0, 0, 1, 0, 0, 0, 1)
			...
			for i,v in pairs(obj1:GetChildren()) do
				v.Touched:connect(function(hit)
					if hit:IsDescendantOf(char) == false and
						hit.Parent:IsA('Accessory') == false and hit.Parent ~= obj1 then
						flyy:Destroy()
				...
				if touched == false then
					if hit:IsDescendantOf(char) == false and
						...
						pcall(function()
							...
							weld.Part1 = obj9
							weld.C0 =
								hit.CFrame:toObjectSpace(obj9.CFrame)
						end)
						pcall(function()
							hit.Anchored = false
								+0.004
						...
						for i=1,100 do
							obj4.Transparency = obj4.Transparency
							wait()
						end
						sound:Destroy()
						infect(hit.Parent)
...
function mustard()
	...
	pcall(function()
		...
		for i=1,4 do
			weld.C1 = start2:lerp(Part1Joint,i/4)
			weld.C0 = start:lerp(Part0Joint * (CFr-CFr.p) *
				RotationOffset,i/4)
			char.Torso.Neck.C0 = start3:lerp(Part0JointHead * (CFr2-
				CFr2.p) * CFrame.Angles(0,0,0),1)
			char.Torso.Neck.C1 = start4:lerp(Part1JointHead,1)
			wait()
		end
		handle["bullet ejaculator"].Grenade:Play()
		...
		pcall(function()
			...
			throw.Touched:connect(function(hit)
				if hit and hit.Parent and activated == false and
					hit.CanCollide == true and hit:IsDescendantOf(char) == false then
					...
					hitdetect.Touched:connect(function(hedeads)
						...
						if hedead ~= player.Character and hedead and hedead:FindFirstChildOfClass('Humanoid') and hedead:FindFirstChild('gassedlol') == nil then
							...
							pcall(function()
								...
								sound:Play()
								for i,v in
									pairs(hedead:GetDescendants()) do
									if v:IsA('BasePart') then
...
function infectthenoobs()
	...
	pcall(function()
		...
		pcall(function()
			local obj2 = Instance.new("Part")
			obj2.CFrame = CFrame.new(Vector3.new(-5.3000598, 0.500012994,
				-7.10008478)) * CFrame.Angles(0, 1.5707963705063, 0)
			obj2.FormFactor = Enum.FormFactor.Symmetric
			obj2.Elasticity = 1
			obj2.TopSurface = Enum.SurfaceType.Smooth
			obj2.BottomSurface = Enum.SurfaceType.Smooth
	...
	pcall(function()
		...
		if Point.Z > 0 then
			...
			elseif Point.X < 0 then
				spawn(function()
					for i=1,4 do
						local startree = char.HumanoidRootPart.CFramechar.HumanoidRootPart.CFrame
						startree:lerp(CFrame.new(char.HumanoidRootPart.Position,Vector3.new(mouse.Hit.X,char.HumanoidRootPart.Position.Y,mouse.Hit.Z))*CFrame.Angles(0,math.rad(-90),0),i/4)
						wait()
					end
				end)
...
function fireworkit()
	...
	pcall(function()
		...
		pcall(function()
			...
			spawn(function()
				repeat wait(0.05) waited = waited+0.05 until waited > 1.8 or
					touched
				...
				local Region = Region3.new(Point1,Point2)
				for _,Part in
					pairs(workspace:FindPartsInRegion3(Region,nil,math.huge)) do
...
function bangbang()
	...
	pcall(function()
		...
		weld.C1 = start2
		local Point =
			char.HumanoidRootPart.CFrame:vectorToObjectSpace(mouse.Hit.p-char.HumanoidRootPart.CFrame.p)
		local old = char.HumanoidRootPart.CFrame
		if Point.Z > 0 then
			if Point.X > 0 then
				char.HumanoidRootPart.CFrame = CFrame.new(char.HumanoidRootPart.Position,Vector3.new(mouse.Hit.X,char.HumanoidRootPart.Position.Y,mouse.Hit.Z))*CFrame.Angles(0,math.rad(90),0)
		...
		pcall(function()
			...
			repeat
				if part and part.Parent then
					if part.CanCollide == false and
						part.Parent:FindFirstChildOfClass('Humanoid') == nil then
...
local function katanaF()
	...
	pcall(function()
		...
		local ree=0
		while (goteem == nil or goteem2 == nil or goteem3 == nil) and ree <
			1 do
			wait(0.05)
			ree=ree+0.05
		end
		...
		cor1 = coroutine.wrap(function()
			lerp(lweld,lweld.C0,CFrame.new(-1.6, 0.1, 0) *
				CFrame.Angles(math.rad(0), math.rad(0), math.rad(-20)),0.08)
		end)
		cor2 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
				CFrame.Angles(math.rad(0), math.rad(45), math.rad(0)),0.08)
		end)
		cor3 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(2, 0.5, -1) * CFrame.Angles(0,
				math.rad(45), math.rad(90)),0.08)
		end)
		cor4 = coroutine.wrap(function()
			lerp(mweld,mweld.C0,CFrame.new(-0.75, -2, 0) *
				CFrame.Angles(0, math.rad(0), math.rad(-15)),0.08)
		end)
		cor1()
		cor2()
		cor3()
...
function longrangethotdestroyer()
	...
	pcall(function()
		...
		local coru=coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0, 0) *
				CFrame.Angles(math.rad(60), math.rad(0), math.rad(0)),0.1)
		end)
		coru()
		lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
			CFrame.Angles(math.rad(0),math.rad(-45),math.rad(0)), 0.1)
		wait(0.75)
...
function REMOVETHETHOTS()
	...
	pcall(function()
		...
		local coru=coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0, 0) *
				CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)),0.1)
		end)
		coru()
		lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
			CFrame.Angles(math.rad(0),math.rad(0),math.rad(0)), 0.1)
...
function katanaswing()
	...
	pcall(function()
		...
		local trail = Instance.new("Trail", handle)
		trail.Color = ColorSequence.new({ColorSequenceKeypoint.new(0,
			trail.Parent.Color), ColorSequenceKeypoint.new(1, trail.Parent.Color)})
		trail.LightEmission = 0.25
		trail.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,
			0.9), NumberSequenceKeypoint.new(1, 1)})
		trail.Lifetime = 0.10
		trail.MinLength = 0.05
		trail.Attachment0 = at1
		trail.Attachment1 = at2
		...
		cor()
		lerp(rweld,rweld.C0,CFrame.new(2, 0.5, 0) * CFrame.Angles(0, math.rad(0),
			math.rad(90)),0.04)
		wait(0.2)
		swinging = false
		trail:Destroy()
		...
		at2:Destroy()
		local cor = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) * CFrame.Angles(0, 0,
				0),0.08)
		end)
		cor()
...
function throw()
	...
	pcall(function()
		...
		lerp(lweld,lweld.C0,CFrame.new(-1.3, 0.7, -1) * CFrame.Angles(0,
			math.rad(-70), math.rad(-105)),0.04)
		wait(0.15)
		throwvel:Remove()
		local cor = coroutine.wrap(function()
			lerp(lweld,lweld.C0,CFrame.new(-1.5, 0, 0) * CFrame.Angles(0,
				0, 0),0.08)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.5, 0, 0) * CFrame.Angles(0,
				0, 0),0.08)
		end)
		cor()
		cor2()
...
function whoosh(vroom)
	...
	vroom.CFrame =
		CFrame.new(char.Head.CFrame.p,mouse.Hit.p)*CFrame.Angles(math.rad(0),math.rad(90
			),math.rad(0))
	vroom.Anchored = true
			...
			v.Touched:connect(function(hit)
				...
				if touched == false then
					if hit and hit.Parent and
						hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent~= char then
						touched = true
						pcall(function()
							local sound =
								Instance.new('Sound',vroom)
							sound.SoundId =
								'rbxassetid://220833967'
							sound.MaxDistance = 200
							sound.Volume = 1
							sound:Play()
						end)
						...
						pcall(function()
							...
							anchorpart.CFrame:toObjectSpace(ayybleed.CFrame)
						...
						if hit.Name == "Head" or hit.Name ==
							"UpperTorso" or hit.Name == "Torso" or hit.Name == "LowerTorso" or hit.Name ==
					...
					elseif hit and hit.CanCollide == true and hit.Parent and hit.Parent ~= char then
						...
						for _,a in pairs(vroom:GetChildren()) do
							if a:IsA('BasePart') and
								string.find(a.Name,'thicc cap') == nil then
								for _,c in
									pairs(a:GetTouchingParts()) do
									if c == hit then
										touchingit = true
									end
								end
...
function whooshboom(vroom)
	...
	vroom.Name = "Projectile"
	vroom.CFrame =
		CFrame.new(char.Head.CFrame.p,mouse.Hit.p)*CFrame.Angles(math.rad(0),math.rad(90),math.rad(0))
	vroom.Anchored = true
	vroom.Velocity = Vector3.new(0,0,0)
	vroom.RotVelocity = Vector3.new(0,0,0)
	vroom.Anchored = false
	...
	pcall(function()
		...
		local cor = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.75, 1, 0.25) *
				CFrame.Angles(math.rad(35), math.rad(0), math.rad(150)),0.1)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) * CFrame.Angles(0,
				math.rad(-45), math.rad(0)),0.1)
		end)
		local cor3 = coroutine.wrap(function()
			lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
				CFrame.Angles(math.rad(-180),math.rad(-90), 0),0.1)
		end)
		cor()
		cor2()
		cor3()
		lerp(lweld,lweld.C0,CFrame.new(-1.75, 0.5, -0.5) *
			CFrame.Angles(math.rad(90), math.rad(0), math.rad(-45)),0.1)
		wait(0.2)
		stabb = true
		local cor = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.75, 1, -0.5) *
				CFrame.Angles(math.rad(-45), math.rad(0), math.rad(150)),0.04)
		end)
		local cor2 = coroutine.wrap(function()
			lerp(tweld,tweld.C0,CFrame.new(0, -1, 0) *
				CFrame.Angles(math.rad(-30), math.rad(25), math.rad(0)),0.04)
		end)
		local cor3 = coroutine.wrap(function()
			lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
				CFrame.Angles(math.rad(-180),math.rad(-90), 0),0.04)
		end)
		cor()
		cor2()
		cor3()
		lerp(lweld,lweld.C0,CFrame.new(-1.75, 0.5, 0.5) *
			CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-45)),0.04)
		if stabb == true then
			stabb = false
			trail:Remove()
			at1:Remove()
			at2:Remove()
			local cor = coroutine.wrap(function()
				lerp(rweld,rweld.C0,CFrame.new(1.75, 0, -0.3) *
					CFrame.Angles(math.rad(-130), math.rad(0), math.rad(150)),0.05)
			end)
			local cor2 = coroutine.wrap(function()
				lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
					CFrame.Angles(math.rad(-15), math.rad(40), math.rad(0)),0.05)
			end)
			local cor3 = coroutine.wrap(function()
				lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
			...
			cor2()
			cor3()
			lerp(lweld,lweld.C0,CFrame.new(-1.6, 0.5, 0) *
				CFrame.Angles(math.rad(-0), math.rad(0), math.rad(-30)),0.05)
			local cor = coroutine.wrap(function()
				lerp(rweld,rweld.C0,CFrame.new(1.5, 0, 0) *
					CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)),0.15)
			end)
			local cor2 = coroutine.wrap(function()
				lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
					CFrame.Angles(0, math.rad(0), math.rad(0)),0.1)
			end)
			local cor3 = coroutine.wrap(function()
				lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
					CFrame.Angles(math.rad(-180),math.rad(-90), 0),0.1)
		...
		elseif stabb == false then
			...
			if continuestab == true then
				local cor = coroutine.wrap(function()
					lerp(rweld,rweld.C0,CFrame.new(1.75, 1, 0.25) *
						CFrame.Angles(math.rad(35), math.rad(0), math.rad(150)),0.05)
				end)
				local cor2 = coroutine.wrap(function()
					lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
						CFrame.Angles(math.rad(-10), math.rad(-45), math.rad(0)),0.05)
				end)
				cor()
				cor2()
				lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
				...
				for i = 1, 3 do
					local cor = coroutine.wrap(function()
						lerp(rweld,rweld.C0,CFrame.new(0.75, 2,
							0.25) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(200)),0.05)
					end)
					local cor2 = coroutine.wrap(function()
						lerp(tweld,tweld.C0,CFrame.new(0, -0.4,
							-0.7) * CFrame.Angles(math.rad(-10), math.rad(0), math.rad(0)),0.05)
					end)
					local cor3 = coroutine.wrap(function()
						lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
							CFrame.Angles(math.rad(-180),math.rad(-90), 0),0.05)
					...
					cor2()
					cor3()
					lerp(lweld,lweld.C0,CFrame.new(-0.75, 2, 0.25) *
						CFrame.Angles(math.rad(0), math.rad(0), math.rad(-200)),0.05)
					wait(0.35)
					stabb = true
					local cor = coroutine.wrap(function()
						lerp(rweld,rweld.C0,CFrame.new(0.75, 0.75,
							-1.5) * CFrame.Angles(math.rad(-70), math.rad(0), math.rad(200)),0.04)
					end)
					local cor2 = coroutine.wrap(function()
						lerp(tweld,tweld.C0,CFrame.new(0, -1, -1) *
							CFrame.Angles(math.rad(-40), math.rad(0), math.rad(0)),0.04)
					end)
					local cor3 = coroutine.wrap(function()
						lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
							CFrame.Angles(math.rad(-180),math.rad(-90), 0),0.04)
					...
					cor2()
					cor3()
					lerp(lweld,lweld.C0,CFrame.new(-0.75, 0.75, -1.5)
						* CFrame.Angles(math.rad(-70), math.rad(0), math.rad(-200)),0.04)
				end
				wait(0.3)
				local cor = coroutine.wrap(function()
					lerp(rweld,rweld.C0,CFrame.new(1.5, 1, 0.25) *
						CFrame.Angles(math.rad(0), math.rad(0), math.rad(140)),0.05)
				end)
				local cor2 = coroutine.wrap(function()
					lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
						CFrame.Angles(math.rad(-10), math.rad(0), math.rad(0)),0.05)
				end)
				local cor3 = coroutine.wrap(function()
					lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
						CFrame.Angles(math.rad(-180),math.rad(-90), 0),0.05)
				...
				local cor2 = coroutine.wrap(function()
					lerp(tweld,tweld.C0,CFrame.new(0, 0, 0) *
						CFrame.Angles(0, math.rad(-45), math.rad(0)),0.05)
				end)
				cor()
				cor2()
				lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
...
function fling()
	...
	pcall(function()
		...
		trail.Attachment1 = at2
		local cor = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(1.75, 0, 0) * CFrame.Angles(0,
				math.rad(0), math.rad(45)),0.07)
		end)
		cor()
...
function kill()
	...
	pcall(function()
		...
		lerp(rweld,rweld.C0,CFrame.new(0.5, 0.7, -0.70) * CFrame.Angles(0,
			math.rad(100), math.rad(105)),0.1)
		wait(0.2)
		lerp(rweld,rweld.C0,CFrame.new(2, 0.5, 0) * CFrame.Angles(0,
			math.rad(0), math.rad(90)),0.04)
		killsound:Play()
		killsoundac:Play()
		chokesound:Play()
		bleedsound:Play()
		...
		trail.Attachment0 = at1
		trail.Attachment1 = at2
		lerp(rweld,rweld.C0,CFrame.new(1.5, 0.15, 0.4) * CFrame.Angles(0,
			math.rad(-40), math.rad(15)),0.08)
		lerp(rweld,rweld.C0,CFrame.new(1.5, 0.15, 0.4) * CFrame.Angles(0,
			math.rad(-30), math.rad(15)),0.1)
		local coru=coroutine.wrap(function()
			lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) *
				CFrame.Angles(math.rad(0),math.rad(-90), 0), 0.07)
			lerp(hweld,hweld.C0,CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(-
...
function grab()
	...
	pcall(function()
		...
		local cor = coroutine.wrap(function()
			lerp(rweld,rweld.C0,CFrame.new(2, 0.5, 0) * CFrame.Angles(0,
				math.rad(0), math.rad(90)),0.08)
		end)
		cor()
		lerp(lweld,lweld.C0,CFrame.new(-2, 0.5, 0) * CFrame.Angles(0,
			math.rad(0), math.rad(-90)),0.08)
		wait(0.15)
		grabbing = true
		local cor = coroutine.wrap(function()
		...
		cor()
		lerp(lweld,lweld.C0,CFrame.new(-1.25, 0.7, -0.75) * CFrame.Angles(0,
			math.rad(-140), math.rad(-105)),0.08)
		at1:Remove()
		at2:Remove()
		trail:Remove()
		wait(0.3)
...
function hellisreal()
	working = true
	pcall(function()
		local s1 = Instance.new("Sound", char.Torso)
		...
		s2.Volume = 0.75
		s2:Play()
		local demon = Instance.new("Sound", char.Torso)
		demon.SoundId = "rbxassetid://1534314061"
		demon.TimePosition = 0
		demon.PlaybackSpeed = 1
		demon.Volume = 2
		demon:Play()
		local s3 = Instance.new("Sound", char.Torso)
		...
		local rp = char.HumanoidRootPart.RootJoint
		local lh = char.Torso["Left Hip"]
		local ls = char.Torso["Left Shoulder"]
		local rh = char.Torso["Right Hip"]
		local rs = char.Torso["Right Shoulder"]
		local n1 = char.Torso.Neck:Clone()
...
spawned()
Event2.OnServerEvent:Connect(function(damnyou, inputObject, gameProcessedEvent)
	if focused == false then
		...
		if usable and working == false then
			...
			elseif key == Enum.KeyCode.RightAlt or key == Enum.KeyCode.LeftAlt
			then
				if ruhroh then
			...
			elseif key == Enum.KeyCode.F then
				...
				elseif blademode == "gun" then
					...
					--katanaF()
				elseif blademode == "fisticuffs" then
					pOUNCHH(char["Left Arm"]:FindFirstChild("lweld"),
						char["Right Arm"]:FindFirstChild("rweld"),
						char.HumanoidRootPart:FindFirstChild("tweld"))
				end
		...
		if child.Name == "blade" then
			child.Touched:connect(function(hit)
				if blademode == "katana" and swinging then
					if gettingeem then
						if goteem == nil or goteem2 == nil or
							goteem3 == nil then
							if hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent ~= goteem and hit.Parent ~= goteem2 and hit.Parent ~= goteem3 and hit.Parent:FindFirstChildOfClass('Humanoid').Health > 0 and hit.Parent ~= char then
								...
								pcall(function()
									...
									if attachment0 and attachment1 then
										...
										coroutine.wrap(function()
											local bleedBLEED=bleed(ayybleed)
											bleedBLEED()
										end)
									end
					...
					elseif SLESH then
						if hit.Parent and
							hit.Parent:FindFirstChild('CHOPPED') == nil and
							hit.Parent:FindFirstChildOfClass('Humanoid') and
							hit.Parent:FindFirstChildOfClass('Humanoid').Health > 0 and hit.Parent ~= char
						then
				...
				elseif blademode == "knife" then
					...
					elseif hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent:FindFirstChildOfClass('Humanoid').Health > 0 and hit.Parent ~= char and stabb == true then
						...
						if continuestab == false then
							...
							attachment1.Position = Vector3.new(-0.55,0,0)
							attachment1.Orientation = Vector3.new(90, 0,-90)
							local attachment0 =Instance.new('Attachment',ayybleed)
							pcall(function()
				...
				elseif blademode == "fisticuffs" then
					if poom == true and hit and hit.Parent and
						...
						if
							...
							spawn(function()
								while
									text:IsDescendantOf(workspace) do
...
avgs = {}
--[[ moved to LocalScript
game:GetService('RunService').Heartbeat:connect(function(step)
	local ofps = 1/game:GetService("RunService").PreSimulation:wait()
	if #avgs > 100 then
		table.remove(avgs,1)
	end
...
spawn(function()
	while wait(0.2) do
		...
		if tracking ~= nil then
			...
			Tools.Text = stringz
			pcall(function()
				Health.Text = "Health: "..math.floor(tracking:FindFirstChildOfClass('Humanoid').Health+0.5).."/"..math.
					floor(tracking:FindFirstChildOfClass('Humanoid').MaxHealth+0.5)
			end)
			...
			if pathfinding then
				...
				Event3:FireClient(player, "pathfinding", part)
			else
				TogglePath.Text = 'Toggle Pathfinding (Off)'
			end
			if linetracking then
				ToggleTracking.Text = 'Toggle Tracking (On)'
				Event3:FireClient(player, "linetracking", part)
			else
				ToggleTracking.Text = 'Toggle Tracking (Off)'
			end
